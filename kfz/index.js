...
const KEY_LIST = readListDefault('key-list', DEFAULT_KEY_SETTINGS['key-list']);
const KEY_ORDER = readListDefault('key-order', DEFAULT_KEY_SETTINGS['key-order']);
const EXCLUDE_KEYS = [
    "licenseNumber"
];
...
const search_space = DATA.map((e, idx) => {
    ...
    return [e.licenseNumber.toLocaleLowerCase(), document.getElementById('plate-list').lastElementChild];
});
